...
-- This file contains the complete schema for the Shopping Planner application
...
CREATE INDEX IF NOT EXISTS idx_offers_time_range ON offers(start_time, end_time);
